...
public class Marks extends JFrame implements ActionListener {
    ...
    Marks(String rollno) {
        ...
        setSize(500, 600);
        setLocation(500, 100);
        ImageIcon icon = new ImageIcon(ClassLoader.getSystemResource("Images/marks.png"));
        setIconImage(icon.getImage());
        setLayout(null);
        
        getContentPane().setBackground(Color.WHITE);
        
        JLabel heading = new JLabel("University of Lahore (SRG)");
        ...
        try {
            ...
            ResultSet rs1 = c.sta.executeQuery("select * from subject where roll_no = '"+rollno+"'");
            while(rs1.next()) {
            ...
            ResultSet rs2 = c.sta.executeQuery("select * from marks where roll_no = '"+rollno+"'");
            while(rs2.next()) {
