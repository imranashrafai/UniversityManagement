...
public class UpdateTeacher extends JFrame implements ActionListener{
    ...
    UpdateTeacher() {
        ...
        try {
            Conn c = new Conn();
            String query = "select * from teacher_record where emp_id='"+crollno.getSelectedItem()+"'";
            ResultSet rs = c.sta.executeQuery(query);
            while(rs.next()) {
                labelname.setText(rs.getString("emp_name"));
                ...
                labelrollno.setText(rs.getString("emp_id"));
        ...
        crollno.addItemListener(new ItemListener() {
            public void itemStateChanged(ItemEvent ie) {
                try {
                    ...
                    ResultSet rs = c.sta.executeQuery(query);
                    while(rs.next()) {
                        labelname.setText(rs.getString("emp_id"));
                        labelfname.setText(rs.getString("father_name"));
                        labeldob.setText(rs.getString("date_birth"));
                        tfaddress.setText(rs.getString("address"));
                        tfphone.setText(rs.getString("phone"));
    ...
    public void actionPerformed(ActionEvent ae) {
        if (ae.getSource() == submit) {
            ...
            try {
                String query = "update teacher_record set address='"+address+"', phone='"+phone+"', email_id='"+email+"', course='"+course+"', branch='"+branch+"' where rollno='"+rollno+"'";
                Conn con = new Conn();
